//var SingingOn = false;
var headline2 = document.getElementsByTagName("p");
...
function highlight(counter){
	document.getElementsByTagName("p")[counter].innerHTML = document.getElementsByTagName("p")[counter].innerText.replace(/\b(\w+)\b/g, 
		function(str){
			if (str) {
				highlighted++;
				words.push(str)
